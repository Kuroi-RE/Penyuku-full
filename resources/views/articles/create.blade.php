  ...
  <div class="py-12 bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">Tulis artikel tentang konservasi penyu</p>
      </div>
      ...
      <div class="bg-white rounded-lg shadow-md p-8">
        <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-6">
            ...
            <input type="text" name="title" id="title" value="{{ old('title') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 @error('title') border-red-500 @enderror" placeholder="Masukkan judul artikel..." required>
            @error('title')
          ...
          <div class="mb-6">
            ...
            <select name="category" id="category" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 @error('category') border-red-500 @enderror" required>
          ...
          <div class="mb-6">
            ...
            <textarea name="excerpt" id="excerpt" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 @error('excerpt') border-red-500 @enderror" placeholder="Tulis ringkasan singkat artikel (maks 500 karakter)..." required>{{ old('excerpt') }}</textarea>
          ...
          <div class="mb-6">
            ...
            <textarea name="content" id="content" rows="15" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 @error('content') border-red-500 @enderror" placeholder="Tulis konten artikel lengkap di sini..." required>{{ old('content') }}</textarea>
            @error('content')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
          </div>
